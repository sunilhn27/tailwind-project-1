    ...
    return (
        <nav className='flex justify-evenly p-5 gap-6 items-center'>
            ...
            <div className='flex space-x-3 items-center text-lg font-sans'>
                ...
                <button className='py-3 px-10 bg-login-blue text-white'>Login</button>
                <button className='text- py-3 px-10 text-register-oraange  border-2 border-register-oraange'>Register</button>
            </div>
        </nav>
    )
}
